...
ADD https://trustmarkinitiative.org/software/tpat-0.9.war /tmp/tpat.war
...
COPY ./images/banner.png /usr/local/tomcat/webapps/artifacts/assets/tmi-header-56eb1cb69ffde28907e0a78527bbd88d.png
